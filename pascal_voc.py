...
import os.path as osp # work with paths
...
def parse_xml(args):
    ...
    w = int(size.find('width').text) # width of the width
    h = int(size.find('height').text) # height of the
    ...
    for obj in root.findall('object'):
        ...
        bbox = [
            int(bnd_box.find('xmin').text), # xmin
            int(bnd_box.find('ymin').text), # ymin
...
def parse_args():
    ...
    parser.add_argument('--devkit_path', default='/home/franz/RTTS/RTTS', help='pascal voc devkit path')
    parser.add_argument('-o', '--out-dir', default='/home/franz/RTTS/rtts_coco', help='output path')
    parser.add_argument(
        '--out-format',
        default='coco',
        choices=('pkl', 'coco'),
